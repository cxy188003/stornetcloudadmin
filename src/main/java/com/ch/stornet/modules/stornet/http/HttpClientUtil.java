package com.ch.stornet.modules.stornet.http;
...
//			System.out.println("响应内容: " + responseContent);
	 ...
	 */
	public static HttpRespResult sendPostRequestByJava(String reqURL, Map<String, String> params){
	 ...
	 * @return 远程主机响应正文`HTTP状态码,如<code>"SUCCESS`200"</code><br>若通信过程中发生异常则返回"Failed`HTTP状态码",如<code>"Failed`500"</code>
	 */
	public static HttpRespResult sendPostRequestByJava(String reqURL, String sendData){
		HttpURLConnection httpURLConnection = null;
		OutputStream out = null; //写
		InputStream in = null;   //读
		int httpStatusCode = 0;  //远程主机响应的HTTP状态码
		HttpRespResult hrr = new HttpRespResult(0) ;
		try{
...
//			return new String(byteDatas) + "`" + httpStatusCode;
			...
			hrr.setHttpRespBody(new String(byteDatas));
			hrr.setHttpStatusCode(httpStatusCode);
			return hrr ;
